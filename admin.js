// ===== API URL Constants =====
    ...
    function renderOrderEmailPreview() {
      ...
      const googleReviewHtml = isReview
        ? `<div style="margin:24px 0;text-align:center;"><a href="https://www.easternshore.ai/review" style="display:inline-block;background:#1a73e8;color:#ffffff;text-decoration:none;padding:14px 28px;border-radius:8px;font-weight:700;font-size:16px;">Leave a Google Review &#9733;</a></div>`
        : '';
